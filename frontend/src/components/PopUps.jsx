...
const PopUps = (props) => {
    ...
    return (
        ...
        {/*The larger class element has a flex item inside it called docs-div that holds the actual moving stuff*/}
            <div className="docs" ref = {docs}><div id="docs-div" ref = {docsElement}><img className="icons" src="/popup-icons/docs.svg" height='65px'/></div><div className="inner-words"><SlideUp title={"Docs for this project"} project={props.project} poptype={"Documents"}/></div></div>
            <div className="vids" ref = {vids}><div id="vids-div" ref = {vidsElement}><img className="icons" src="/popup-icons/videos.svg" height='65px'/></div><div className="inner-words"><SlideUp title={"Browse related videos"} project={props.project} poptype={"Videos"}/></div></div>
            <div className="pics" ref = {pics}><div id="pics-div" ref = {picsElement}><img className="icons" src="/popup-icons/photos.svg" height='65px'/></div><div className="inner-words"><SlideUp title={"View photos"} project={props.project} poptype={"Photos"}/></div></div>
            <div className="demo" ref = {demo}><div id="demo-div" ref = {demoElement}><img className="icons" src="/popup-icons/demos.svg" height='65px'/></div><div className="inner-words"><SlideUp title={"Watch a demo"} project={props.project} poptype={"Demo"}/></div></div>
            </div>
    )
}
